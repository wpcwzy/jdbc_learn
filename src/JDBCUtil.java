...
public class JDBCUtil {
    ...
    public void addUser(String username,String password,String phone) throws java.sql.SQLException {
    ...
    public void updateUser(String username,String password,String phone) throws java.sql.SQLException {
        try(Connection conn= DriverManager.getConnection(JDBC_URL,JDBC_USERNAME,JDBC_PWD)){
    ...
    public String getPhone(String username) throws java.sql.SQLException {
        try(Connection conn= DriverManager.getConnection(JDBC_URL,JDBC_USERNAME,JDBC_PWD)){
